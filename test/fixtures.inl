...
#define DF(g, s) {                                           \
  ...
  F("2.460578477798307e29", 0xca, 0x70, 0x46, 0xc3, 0x92),
  F("1.3502847071725796e34", 0xca, 0x78, 0x26, 0x6f, 0x79),
  F("-2.1088339408059653e-10", 0xca, 0xaf, 0x67, 0xde, 0x66),
  F("-2.7540517940439024e30", 0xca, 0xf2, 0x0b, 0x0b, 0x49),
  ...
  F("-3.64378489333011e-199", 0xcb, 0x96, 0xbb, 0xe4, 0x30,
                                    0xd8, 0x4f, 0x48, 0x84),
  F("-3.7908138174749756e148", 0xcb, 0xde, 0xc7, 0xb7, 0x9e,
                                     0x91, 0x92, 0x99, 0xef),
  F("1.9423862325881795e243", 0xcb, 0x72, 0x72, 0x34, 0xc8,
                                    0xe2, 0xd1, 0xbc, 0x6c),
